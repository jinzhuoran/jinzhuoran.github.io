...
I am now an assistant professor at the [Institute of Automation, Chinese Academy of Sciences (CASIA)](http://www.ia.ac.cn/). Before that, I received my Ph.D. degree from the Natural Language Processing and Knowledge Engineering Group (NLPKE), Institute of Automation, Chinese Academy of Sciences (CASIA), in 2026, advised by [Prof. Jun Zhao](https://zhaojun-nlpr.github.io/). I obtained my B.E. degree in Software Engineering from [Northeastern University (NEU)](https://www.neu.edu.cn/) in 2021. My research interests include **large language models**, **agents**, **natural language processing**, and **knowledge engineering**. I have published over **30 papers** at top-tier conferences, including NeurIPS, ICLR, ACL, AAAI, EMNLP, NAACL, and COLING.
